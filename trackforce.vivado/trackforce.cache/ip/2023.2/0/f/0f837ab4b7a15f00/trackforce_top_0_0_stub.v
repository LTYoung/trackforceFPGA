...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk_i, rst_i, gps_rx_i, imu_rx_x_i, imu_rx_y_i, 
  imu_rx_z_i, gps_vel_o, gforce_x_o, gforce_y_o, jb, led)
/* synthesis syn_black_box black_box_pad_pin="rst_i,gps_rx_i[7:0],imu_rx_x_i[7:0],imu_rx_y_i[7:0],imu_rx_z_i[7:0],gps_vel_o[7:0],gforce_x_o[7:0],gforce_y_o[7:0],jb[7:0],led[3:0]" */
