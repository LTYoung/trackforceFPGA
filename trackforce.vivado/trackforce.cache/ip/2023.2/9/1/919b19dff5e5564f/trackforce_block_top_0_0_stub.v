...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk_i, rst_i, sw, gps_byte_i, imu_x_i, imu_y_i, 
  valid_i, vel_o, x_o, y_o, jc, jd, je, led)
/* synthesis syn_black_box black_box_pad_pin="rst_i,sw[3:0],gps_byte_i[7:0],imu_x_i[7:0],imu_y_i[7:0],valid_i[1:0],vel_o[7:0],x_o[7:0],y_o[7:0],jc[7:0],jd[7:0],je[7:0],led[3:0]" */
