...
/* synthesis syn_black_box black_box_pad_pin="clk_i,rst_i,gps_rx_i[7:0],imu_rx_x_i[7:0],imu_rx_y_i[7:0],imu_rx_z_i[7:0],gps_valid_i[0:0],gps_vel_o[7:0],gforce_x_o[7:0],gforce_y_o[7:0],je[7:0],led[3:0]" */;
  input clk_i;
  input rst_i;
  input [7:0]gps_rx_i;
