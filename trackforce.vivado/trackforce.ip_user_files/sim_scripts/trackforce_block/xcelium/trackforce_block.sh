...
#
# Script generated by Vivado on Mon Dec 11 18:33:59 -0500 2023
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : trackforce_block.sh
...
#
# Usage        : trackforce_block.sh
#                trackforce_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                trackforce_block.sh [-reset_run]
#                trackforce_block.sh [-reset_log]
#                trackforce_block.sh [-help]
#
...
#                script (type 'trackforce_block.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_15 -libname processing_system7_vip_v1_0_17 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_31 -libname generic_baseblocks_v2_1_1 -libname axi_register_slice_v2_1_29 -libname fifo_generator_v13_2_9 -libname axi_data_fifo_v2_1_28 -libname axi_crossbar_v2_1_30 -libname axi_protocol_converter_v2_1_29 -libname proc_sys_reset_v5_0_14 -libname lib_pkg_v1_0_3 -libname lib_srl_fifo_v1_0_3 -libname axi_uartlite_v2_0_33 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 xil_defaultlib axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_5 axi_gpio_v2_0_31 generic_baseblocks_v2_1_1 axi_register_slice_v2_1_29 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_crossbar_v2_1_30 axi_protocol_converter_v2_1_29 proc_sys_reset_v5_0_14 lib_pkg_v1_0_3 lib_srl_fifo_v1_0_3 axi_uartlite_v2_0_33)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "trackforce_block.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./trackforce_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/ec67/hdl" +incdir+"../../../../trackforce.gen/sources_1/bd/trackforce_block/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.trackforce_block xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.trackforce_block -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log trackforce_block_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./trackforce_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: trackforce_block.sh [-help]\n\
Usage: trackforce_block.sh [-step]\n\
Usage: trackforce_block.sh [-lib_map_path]\n\
Usage: trackforce_block.sh [-reset_run]\n\
Usage: trackforce_block.sh [-reset_log]\n\
Usage: trackforce_block.sh [-keep_index]\n\
Usage: trackforce_block.sh [-noclean_files]\n\n\
