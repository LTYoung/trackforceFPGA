...
HD_PWD='D:/GitHub/trackforce/trackforce.vivado/trackforce.runs/trackforce_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trackforce_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trackforce_top_0_0.tcl
