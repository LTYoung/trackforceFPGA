...
HD_PWD='D:/GitHub/trackforceVerilog/trackforce.vivado/trackforce.runs/trackforce_block_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trackforce_block_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trackforce_block_rst_ps7_0_50M_0.tcl
