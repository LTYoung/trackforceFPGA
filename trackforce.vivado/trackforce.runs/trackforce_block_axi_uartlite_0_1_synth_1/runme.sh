...
HD_PWD='D:/GitHub/trackforceVerilog/trackforce.vivado/trackforce.runs/trackforce_block_axi_uartlite_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trackforce_block_axi_uartlite_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trackforce_block_axi_uartlite_0_1.tcl
