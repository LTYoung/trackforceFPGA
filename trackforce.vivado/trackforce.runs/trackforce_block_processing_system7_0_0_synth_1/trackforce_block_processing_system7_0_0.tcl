...
synth_design -top trackforce_block_processing_system7_0_0 -part xc7z020clg400-1 -incremental_mode off -mode out_of_context
OPTRACE "synth_design" END { }
if { [get_msg_config -count -severity {CRITICAL WARNING}] > 0 } {
 send_msg_id runtcl-6 info "Synthesis results are not added to the cache due to CRITICAL_WARNING"
}

rename_ref -prefix_all trackforce_block_processing_system7_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef trackforce_block_processing_system7_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "trackforce_block_processing_system7_0_0_synth_1_synth_report_utilization_0" "report_utilization -file trackforce_block_processing_system7_0_0_utilization_synth.rpt -pb trackforce_block_processing_system7_0_0_utilization_synth.pb"
...
OPTRACE "trackforce_block_processing_system7_0_0_synth_1" END { }
