...
HD_PWD='D:/GitHub/trackforce/trackforce.vivado/trackforce.runs/trackforce_axi_gpio_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trackforce_axi_gpio_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trackforce_axi_gpio_0_3.tcl
