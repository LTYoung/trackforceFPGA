...
HD_PWD='D:/GitHub/trackforceVerilog/trackforce.vivado/trackforce.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trackforce_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trackforce_block_wrapper.tcl -notrace
