...
HD_PWD='D:/GitHub/trackforce/trackforce.vivado/trackforce.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trackforce_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trackforce_wrapper.tcl -notrace
